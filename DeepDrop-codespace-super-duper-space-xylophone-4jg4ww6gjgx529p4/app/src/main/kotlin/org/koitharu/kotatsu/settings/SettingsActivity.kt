...
class SettingsActivity :
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		// Settings always enters as a full-screen slide from the right, and (see finish())
		// leaves back out to the right the same way it came in — one consistent left/right axis.
	...
	override fun finish() {
		super.finish()
		// Mirror the entry animation so Settings always slides back out to the right,
		// with the previous screen sliding back in from the left underneath it.
		@Suppress("DEPRECATION")
